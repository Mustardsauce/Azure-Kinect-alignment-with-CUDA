...
find_path(K4A_ROOT_DIR REQUIRED)

IF (K4A_ROOT_DIR)

find_library(K4A_LIBRARY NAMES k4a NO_DEFAULT_PATH PATHS ${K4A_ROOT_DIR}/sdk/windows-desktop/amd64/release/lib)
find_library(K4ARECORD_LIBRARY NAMES k4arecord NO_DEFAULT_PATH PATHS ${K4A_ROOT_DIR}/sdk/windows-desktop/amd64/release/lib)
find_path(K4A_INCLUDE_DIR NAMES k4a/k4a.h PATHS ${K4A_ROOT_DIR}/sdk/include)

IF (K4A_INCLUDE_DIR AND K4A_LIBRARY AND K4ARECORD_LIBRARY)
   SET(K4A_FOUND TRUE)
   SET(K4A_INCLUDE_DIRS ${K4A_INCLUDE_DIR})
   SET(K4A_BIN_DIRS ${K4A_ROOT_DIR}/sdk/windows-desktop/amd64/release/bin)
   SET(K4A_LIBRARIES ${K4A_LIBRARY} ${K4ARECORD_LIBRARY})   

   # Compatibility with linux names
   SET(k4a_LIBRARIES ${K4A_LIBRARIES})
   SET(k4a_BIN_DIRS ${K4A_BIN_DIRS})
